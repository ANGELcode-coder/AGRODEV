...
<body>
    ...
    <form action="add_product" method="post" enctype="multipart/form-data">
        ...
        <table id="tab" align="center" width="600" border=3>
            ...
            <tr id="prostock">
                <td align="center"><b>Type : <br></b></td>
                <td colspan=2><input type="text" name="product_type" required></td>
            </tr>

            <tr id="procalender">
                <td align="center"><b>Expiry : <br></b></td>
            ...
            <tr align="center">
                <td colspan=4><input type="submit" id="insnow" name="insert_post" value="Add Products"></td>
            </tr>
        </table>
    </form>
...
if (isset($_POST['insert_post'])) {    // when button is clicked
    ...
    if (isset($_SESSION['phonenumber'])) {
        ...
        if ($insert_pro) {
            ...
            echo "<script>window.open('add_product','_self')</script>";
        } else {
