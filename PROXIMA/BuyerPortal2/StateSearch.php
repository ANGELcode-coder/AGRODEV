...
<div class=" flex-row-reverse left ">
    ...
    <a class="float-left" href="bhome.php">
        <img src="LOGO4.PNG" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
    </a>
</div>
...
<a class="float-left" href="bhome.php">
    <img src="LOGO4.PNG" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
</a>
    ...
    <div class="text-success  login">Login</div>
     ...
     <div class="container ">
          ...
          <div class="row">
               ...
               if (isset($_GET['state'])) {
                    $state = $_GET['state'];
                    $get_id = "select * from farmerregistration where farmer_state = '$state'";
          ...
          <div class="container">
               ...
               <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                         <p><u><a href="https://www.ProXima.com/">ProXima Corporation</a></u> is a Multitrading Company for farmers ang traders</p>
